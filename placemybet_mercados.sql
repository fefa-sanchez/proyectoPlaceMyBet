...
CREATE TABLE `mercados` (
  ...
  KEY `evento` (`evento`),
  CONSTRAINT `mercados_ibfk_1` FOREIGN KEY (`evento`) REFERENCES `eventos` (`idEventos`) ON UPDATE CASCADE
...
INSERT INTO `mercados` VALUES ('BB_1.5','BB',1.5,1.27,2.54),('BB_2.5','BB',2.5,1.59,2.35),('BB_3.5','BB',3.5,2.13,1.84),('VM_1.5','VM',1.5,1.43,2.85),('VM_2.5','VM',2.5,1.9,1.3),('VM_3.5','VM',3.5,2.85,1.43),('ZAM_1.5','ZAM',1.5,2.65,1.32),('ZAM_2.5','ZAM',2.5,1.98,1.65),('ZAM_3.5','ZAM',3.5,1.05,1.87);
